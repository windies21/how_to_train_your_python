...
class TestEqualVsIs(unittest.TestCase):
    def test_equal_vs_is(self):
        ...
        little_python_blue = little_python_green  # share same reference
        print("same? (==) : " + str(little_python_green == little_python_blue))
        print("same? (is) : " + str(little_python_green is little_python_blue))
        print("result is same because green one is: " + str(id(little_python_green)))
        print("and blue one is: " + str(id(little_python_blue)))

        # WHEN
        little_python_blue = little_python_green[:]  # share same value
        print("same? (==) : " + str(little_python_green == little_python_blue))
        print("same? (is) : " + str(little_python_green is little_python_blue))
